...
void connectWebSocket() {
  ...
  websocketsClient.connect(websockets_server_host.c_str(), websockets_server_port, "/esp32/websocket");
}
...
void setup() {
  ...
  // Serial.print("Enter ip host: ");
  // websockets_server_host = Serial.readString();
  // Serial.println("");
